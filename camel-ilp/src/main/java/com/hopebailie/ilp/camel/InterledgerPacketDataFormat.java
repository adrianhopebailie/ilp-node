...
public class InterledgerPacketDataFormat implements DataFormat {
  ...
  public void marshal(Exchange exchange, Object graph, OutputStream stream) throws Exception {
    ...
    InterledgerPacket packet = exchange.getContext().getTypeConverter().mandatoryConvertTo(InterledgerPacket.class,
        graph);
    _context.write(packet, stream);
